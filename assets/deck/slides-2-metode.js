/* ===========================================================================
   Bab 2: Rekam Jejak 2025 & Karya Dosen FMIPA (Slide 5 – 7)
   Keberhasilan perdana di Jogja Gallery dan karya riset sivitas MIPA
   =========================================================================== */
...
(function () {
  ...
  D.push({
    ...
    dark: false,
    num: 5,
    kicker: 'REKAM JEJAK & BUKTI NYATA',
    title: 'Data Art 2025: Bukti Keberhasilan di Jogja Gallery',
    footnote: 'Pameran Data Art 2025: "Life Behind Data" &middot; Jogja Gallery, Kawasan Nol Kilometer Yogyakarta',
    notes: 'Tahun lalu di 2025, kita telah membuktikan bahwa gagasan ini bukan angan-angan. ' +
      'Pameran Data Art perdana di Jogja Gallery sukses besar menampilkan 42 karya dari 27 pameris. ' +
  ...
  D.push({
    ...
    dark: true,
    num: 6,
    kicker: 'PORTOFOLIO DOSEN MIPA UGM',
  ...
  D.push({
    ...
    dark: true,
    num: 7,
    kicker: 'DEMO INTERAKTIF &middot; 8 PROGRAM STUDI',
    title: 'Seluruh Program Studi FMIPA Memiliki Bahasa Seninya Sendiri',
    widget: 'methods-matrix',
    footnote: 'Klik tombol tiap bidang studi untuk melihat bagaimana data lab riil bertransformasi menjadi karya seni visual.',
    notes: 'Bapak dan Ibu, potensi seni ini ada di seluruh 8 program studi di fakultas kita. ' +
      'Ilmu Komputer dengan peta keraguan algoritma AI, Elins dengan spiral denyut jantung, Matematika dengan konjektur Collatz, Fisika dengan atraktor Lorenz, Kimia dengan reaksi reaksi-difusi Gray-Scott, Statistika dengan sebaran stokastik, Aktuaria dengan mortalitas usia, dan Geofisika dengan cincin seismik bumi. ' +
      'Semua karya ini dihitung murni dari kode data tanpa digambar tangan. ' +
      'Inilah modal riset luar biasa yang siap kita tampilkan di hadapan publik Indonesia pada Data Art 2026.',
    html: ''
  });
